...
@router.get("/transaction/category/get/{id}", response_model=baseTransactionCategory)
...
@router.post("/transaction/category/create")
def create_category(
...
@router.put("/transaction/category/update/{id}")
def update_category(
    id:int,
    base_category: CreateTransactionCategory,
    current_user: Annotated[baseUsers, Depends(jwt_manager.get_current_user)],
...
@router.delete("/transaction/category/delete/{id}")
def delete_category(
    id:int,
    current_user: Annotated[baseUsers, Depends(jwt_manager.get_current_user)],
    db: Session = Depends(get_db)
